(globalThis.webpackChunk_canva_web = globalThis.webpackChunk_canva_web || []).push([[91438], {
    11752: t => {
        "use strict";
    ...
    38796: (t, e, n) => {
        ...
        function g(t) {
            ...
            let o, i;
            c.isKanjiModeEnabled() ? (o = f(u.BYTE, r.BYTE, t),
            i = f(u.KANJI, r.KANJI, t)) : (o = f(u.BYTE_KANJI, r.BYTE, t),
            i = []);
                ...
                for (let s = 0; s < t.length; s++) {
                    ...
                    for (let t = 0; t < a.length; t++) {
                        ...
                        for (let t = 0; t < i.length; t++) {
                            ...
                            n[s].lastCount += c.length) : (n[s] && (n[s].lastCount = c.length),
    ...
    ,
    118414: (t, e, n) => {
        const r = n(382969).getSymbolSize;
    ...
    192892: (t, e, n) => {
        ...
        e.create = function(t, e) {
            ...
            let n, i, s = o.M;
            return void 0 !== e && (s = o.from(e.errorCorrectionLevel, o.M),
            n = f.from(e.version),
        ...
        var e = {
            single_source_shortest_paths: function(t, n, r) {
                var o = {}
                  , i = {};
                i[n] = 0;
                var s, a, u, c, l, h, f, g = e.PriorityQueue.make();
                for (g.push(n, 0); !g.empty(); )
                    for (u in a = (s = g.pop()).value,
                    c = s.cost,
                    l = t[a] || {})
                        l.hasOwnProperty(u) && (h = c + l[u],
                        f = i[u],
                        (void 0 === i[u] || f > h) && (i[u] = h,
                        g.push(u, h),
                        o[u] = a));
    ...
    392418: (t, e, n) => {
        ...
        function a(t, e, n, i, s) {
            ...
            2 === u ? (s = n,
            n = e,
            e = i = void 0) : 3 === u && (e.getContext && void 0 === s ? (s = i,
            i = void 0) : (s = i,
            i = n,
            n = e,
            e = void 0));
        ...
        e.getBestVersionForData = function(t, n) {
            ...
            if (Array.isArray(t)) {
                if (t.length > 1)
                    return function(t, n) {
                        for (let r = 1; r <= 40; r++)
                            if (l(t, r) <= e.getCapacity(r, n, s.MIXED))
                                return r
                    }(t, o);
                if (0 === t.length)
                    return 1;
    ...
    999607: (t, e, n) => {
        ...
        e.render = function(t, e, n) {
            const s = r.getOptions(e)
              ...
              , h = "<path " + o(s.color.dark, "stroke") + ' d="' + function(t, e, n) {
                let r = ""
                  , o = 0
                  , s = !1
                  , a = 0;
                for (let u = 0; u < t.length; u++) {
                    ...
                    c || s || (s = !0),
                    t[u] ? (a++,
                    u > 0 && c > 0 && t[u - 1] || (r += s ? i("M", c + n, .5 + l + n) : i("m", o, 0),
                    o = 0,
                    s = !1),
                    c + 1 < e && t[u + 1] || (r += i("h", a),
                    a = 0)) : o++
...
//# sourceMappingURL=sourcemaps/838ebe5470ea94d7.vendor.js.map
